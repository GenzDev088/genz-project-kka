                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected
                        ...
                        : Colors.transparent,
                    border: isSelected
                        ? Border.all(color: page.color, width: 1)
                        : null,
                    boxShadow: isSelected
                        ? [
                            BoxShadow(
                              color: page.color.withOpacity(
                                _neonAnimation.value * 0.6,
                              ),
                              blurRadius: 10,
                              spreadRadius: 1,
                            ),
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [Color(0xFF0D001A), Color(0xFF1A0033), Color(0xFF000000)],
        ),
      ),
      child: SafeArea(
        child: Padding(
            ...
            children: [
              ...
              Container(
                ...
                child: const Row(
                  ...
                  children: [
                    Icon(Icons.analytics, size: 40, color: Color(0xFF00FF00)),
                    SizedBox(width: 16),
                    Text(
                      'STATISTICS',
                      style: TextStyle(
            ...
            children: [
              ...
              Container(
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.person, size: 40, color: Color(0xFFFF0080)),
                    SizedBox(width: 16),
                    Text(
                      'USER PROFILE',
                      style: TextStyle(
            ...
            children: [
              ...
              Container(
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.settings, size: 40, color: Color(0xFFFFFF00)),
                    SizedBox(width: 16),
                    Text(
                      'SYSTEM CONFIG',
                      style: TextStyle(
