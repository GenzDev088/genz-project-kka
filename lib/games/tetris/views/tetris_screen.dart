                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(flex: 4, child: _buildGameBoard()),
  ...
  Widget _buildStatsSection() {
    return Column(
      children: [
        _buildStatCard(
          'SCORE',
          _controller.stats.score.toString(),
        ...
        _buildStatCard(
          'LEVEL',
          _controller.stats.level.toString(),
        ...
        _buildStatCard(
          'LINES',
          _controller.stats.lines.toString(),
        ...
        _buildStatCard(
          'PIECES',
          _controller.stats.pieces.toString(),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            ...
            colors: [Color(0xFF1A0A1A), Color(0xFF2D1B2D), Color(0xFF0F0F0F)],
          ),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: const Color(0xFF00FFFF).withOpacity(0.5),
    ...
    return AspectRatio(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          final row =
              index ~/ TetrisConstants.boardWidth +
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: cell.isOccupied
                  ? [
                      BoxShadow(
                        color: (cell.glowColor ?? Colors.white).withOpacity(
                          0.4,
                        ),
                        blurRadius: 4,
                        spreadRadius: 0.5,
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Icon(
            ...
            color: Colors.white,
            size: 28,
            shadows: const [Shadow(color: Color(0xFF00FFFF), blurRadius: 10)],
          ),
        ),
      ),
    );
        ...
        children: [
          Container(
            ...
            child: const Icon(
              ...
              size: 60,
              color: Colors.white,
              shadows: [Shadow(color: Color(0xFF00FFFF), blurRadius: 20)],
            ),
          ),
          const SizedBox(height: 24),
          const Text(
