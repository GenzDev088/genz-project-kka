...
class _TicTacToeScreenState extends State<TicTacToeScreen>
  ...
  PreferredSizeWidget _buildRetroAppBar() {
    return PreferredSize(
      ...
      child: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFF2D1B69), Color(0xFF5B2C87)],
          ),
          border: Border(
        ...
        child: AppBar(
          ...
          actions: [
            if (gameStarted)
              IconButton(
                icon: const Icon(Icons.info_outline, color: Color(0xFF00FF00)),
  ...
  Widget _buildRetroGrid() {
    return CustomPaint(size: Size.infinite, painter: RetroGridPainter());
  }
        ...
        return SafeArea(
          child: Column(
            children: [
              ...
              Expanded(flex: 3, child: _buildRetroGameBoard()),
              const SizedBox(height: 12),
      ...
      child: Column(
        children: [
          ...
          const Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.info_outline, color: Color(0xFF00FFFF), size: 18),
              SizedBox(width: 8),
              Text(
                'GAME STATUS',
                style: TextStyle(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        shadows: [
                          Shadow(
                            color: _getRetroStatusColor().withOpacity(
                              _neonAnimation.value,
                            ),
                            blurRadius: 10,
                          ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildRetroStatItem(
                'X WINS',
                gameState.playerXScore.toString(),
                const Color(0xFF00FFFF),
              ),
              _buildRetroStatItem(
                'O WINS',
                gameState.playerOScore.toString(),
                const Color(0xFFFF0080),
              ),
              _buildRetroStatItem(
                'DRAWS',
                gameState.drawCount.toString(),
                const Color(0xFFFFFF00),
              ),
            ],
          ),
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            ...
            fontFamily: 'monospace',
            color: color,
            shadows: [Shadow(color: color.withOpacity(0.5), blurRadius: 5)],
          ),
        ),
  ...
  void _makeMove(int position) {
    ...
    setState(() {
      ...
      if (result != GameResult.ongoing) {
        ...
        winningCells = TicTacToeGameController.getWinningPositions(
          newBoard,
          result,
        );
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  _buildRetroDialogStat(
                    'TIME',
                    '${gameState.gameDuration.inSeconds}S',
                  ),
                ],
              ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildRetroInfoItem(
                'MODE',
                gameState.gameMode.displayName.toUpperCase(),
              ),
              if (gameState.gameMode == GameMode.humanVsComputer)
                _buildRetroInfoItem(
                  'DIFFICULTY',
