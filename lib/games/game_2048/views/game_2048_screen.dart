...
class _Game2048ScreenState extends State<Game2048Screen>
  ...
  void initState() {
    ...
    _bestScoreAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(parent: _bestScoreController, curve: Curves.easeOutBack),
    );
  }
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFF0F0F0F), Color(0xFF1A0A1A), Color(0xFF2D1B2D)],
          ),
        ),
        child: SafeArea(
          child: Column(
          ...
          Container(
            ...
            child: const Text(
              ...
              style: TextStyle(
                ...
                letterSpacing: 2.0,
                shadows: [Shadow(color: Color(0xFF06B6D4), blurRadius: 10)],
              ),
            ),
          ),
          const Spacer(),
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 24,
                    fontWeight: FontWeight.bold,
                    shadows: [Shadow(color: glowColor, blurRadius: 15)],
                  ),
                ),
              ],
            ),
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              shadows: [Shadow(color: Color(0x8000FFFF), blurRadius: 5)],
            ),
          ),
        ],
      ),
