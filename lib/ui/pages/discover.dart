...
import 'package:otax/ui/pages/genres.dart';
import 'package:otax/ui/pages/info.dart';
import 'package:otax/ui/pages/news.dart';
...
class Discover extends StatefulWidget {
  ...
  const Discover({super.key, required this.mainNavProvider});
...
class _DiscoverState extends State<Discover> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SmartRefresher(
        ...
        onRefresh: () async {
          await widget.mainNavProvider.refresh(
            refreshPage: 1,
            fromSettings: false,
          );
        },
        ...
        child: SingleChildScrollView(
          physics: isHoveredOverScrollList
          ...
          child: Column(
            children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage('lib/assets/images/chisato.jpeg'),
                            fit: BoxFit.cover,
                            opacity: 0.4,
                          ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(20),
                          image: DecorationImage(
                            image: AssetImage('lib/assets/images/mitsuha.jpg'),
                            fit: BoxFit.cover,
                            opacity: 0.4,
                          ),
                          border: Border.all(color: appTheme.accentColor),
              ...
              _scrollList(
                widget.mainNavProvider.recentlyUpdatedList,
                recentlyUpdatedScrollController,
              ),
              _itemTitle("This season", thisSeasonScrollController),
              _scrollList(
                widget.mainNavProvider.thisSeason,
                thisSeasonScrollController,
              ),
              _itemTitle("Recommended", recommendedScrollController),
              _scrollList(
                widget.mainNavProvider.recommendedList,
  ...
  SizedBox footSpace() {
    return SizedBox(height: MediaQuery.of(context).padding.bottom + 60);
  }
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => Info(id: trendingList[moddedIndex].id),
              ),
            );
          },
          child: Container(
  ...
  Container _itemTitle(String title, ScrollController controller) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(title, style: basicTextStyle("Rubik", 20)),
