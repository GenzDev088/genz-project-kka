    ...
    switch (type) {
      case SortType.AtoZ:
        return setState(() {
          ...
          atozList.forEach((element) {
            element.list.sort(
              (a, b) => a.title['english'] != null
                  ? a.title['english']!.compareTo(
                      b.title['english'] ?? b.title['romaji']!,
                    )
                  : a.title['romaji']!.compareTo(
                      b.title['english'] ?? b.title['romaji']!,
                    ),
            );
          });
      ...
      case SortType.RecentlyUpdated:
        return setState(() {
          final List<UserAnimeList> recentlyUpdatedList = copyRawAnimeList(
            true,
          );
      ...
      child: Container(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return Container(child: getSelectedTabView(currentTabIndex)[index]);
          },
        ),
      ),
    );
