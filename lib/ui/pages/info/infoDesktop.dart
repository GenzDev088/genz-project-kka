...
import 'package:otax/ui/models/widgets/infoPageWidgets/infoSection.dart';
import 'package:otax/ui/models/widgets/infoPageWidgets/watchSection.dart';
...
class _InfoDesktopState extends State<InfoDesktop> {
  ...
  final viewController = AnimeStreamBottomBarController(
    length: 3,
    nonViewIndices: [0],
    animDuration: 00,
  );
                        ...
                        ContextMenu(
                              ...
                              onClick: () async {
                                ...
                                try {
                                  await DownloadManager().addDownloadTask(
                                    img,
                                    "${title['english'] ?? title['romaji'] ?? "unknown"}-Banner",
                                  );
                          ...
                          child: Container(
                            ...
                            margin: EdgeInsets.all(15).copyWith(
                              top: 15 + MediaQuery.paddingOf(context).top,
                            ),
                            child: Opacity(
                              opacity: 0.9,
