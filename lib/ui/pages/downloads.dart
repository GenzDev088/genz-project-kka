  ...
  Widget _buildActive() {
    return ValueListenableBuilder(
      ...
      builder: (ctx, val, child) => (val == 0)
          ? Center(child: Text("Start a download!!"))
          : ListView.builder(
  ...
  Widget _buildHistory() {
    return ValueListenableBuilder(
      ...
      builder: (context, box, child) {
        final values = DownloadHistory.getDownloadHistory(
          status: DownloadStatus.completed,
        );
        return values.length == 0
            ? Center(child: Text("Just like the search history!"))
            : ListView.builder(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Padding(
          ...
          child: Text(
            'Are you sure to delete "${filepath.split("/").last}" from your device?',
          ),
        ),
      ),
    );
