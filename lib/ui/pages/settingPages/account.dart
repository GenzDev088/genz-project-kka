...
import 'package:otax/core/database/mal/login.dart';
            ...
            children: [
              ...
              loading
                  ? Container(
                      ...
                      child: Center(
                        child: AnimeStreamLoading(color: appTheme.accentColor),
                      ),
                    )
                  : ListView.builder(
  ...
  Container _loginCard(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: appTheme.backgroundSubColor, blurRadius: 5),
        ],
      ),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => UserStats(userModal: usermodal!),
          ),
        );
      },
      child: ClipRRect(
              ...
              children: [
                CircleAvatar(
                  backgroundImage: usermodal?.avatar != null
                      ...
                      : AssetImage("lib/assets/images/ghost.png")
                            as ImageProvider,
                  radius: 35,
                ),
                Padding(
