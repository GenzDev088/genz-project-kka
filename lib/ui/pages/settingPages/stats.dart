...
class _UserStatsState extends State<UserStats> {
  ...
  Future<void> fetchUserStats() async {
    try {
      ...
      final genreRes = res.genres.isNotEmpty
          ? await AnilistQueries().getGenreThumbnail(res.genres[0].genre)
          : [];
      setState(() {
        stats = res;
        genreThumbnail = genreRes.isNotEmpty
            ? genreRes[Random().nextInt(genreRes.length)]
            : null;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          icon: Icon(Icons.arrow_back_rounded, color: appTheme.textMainColor),
        ),
        backgroundColor: appTheme.backgroundColor,
        title: Text(
          "Stats",
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: textStyle(
                              17,
                              bold: true,
                            ).copyWith(color: appTheme.textMainColor),
                          ),
                        ),
                      ],
                    ),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: CircleAvatar(
            backgroundImage: user.avatar != null
                ...
                : AssetImage('lib/assets/images/chisato_AI.jpg')
                      as ImageProvider,
        ...
        Container(
          ...
          child: Text("${user.name}", style: textStyle(22, bold: true)),
        ),
        Container(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text("${stats!.notInPlanned}", style: textStyle(18)),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Episodes watched: ", style: textStyle(18, bold: true)),
                  Text("${stats!.episodesWatched}", style: textStyle(18)),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Total time: ", style: textStyle(18, bold: true)),
                  Text(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: genreThumbnail != null
                          ...
                          : AssetImage('lib/assets/images/chisato.jpeg')
                                as ImageProvider,
                      fit: BoxFit.cover,
                      opacity: 0.55,
                    ),
  ...
  Widget _buildStatRow(String label, String value) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Text(label, style: textStyle(18, bold: true)),
        Text(value, style: textStyle(17)),
      ],
    );
  }
}
