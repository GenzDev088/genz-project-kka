                  ...
                  children: [
                    ...
                    ToggleItem(
                      ...
                      onTapFunction: () {
                        ...
                        writeSettings(
                          SettingsModal(fasterDownloads: fasterDownloads),
                        );
                      },
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        await Settings().writeSettings(
                          SettingsModal(downloadPath: dir),
                        );
                        setState(() {});
                        floatingSnackBar(
                          "might need to provide 'allow access to all files' while downloading!",
                        );
                      },
                      child: Container(
                    ...
                    ClickableItem(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => PluginPage()),
                        );
                      },
                    ...
                    ToggleItem(
                      onTapFunction: () {
                        ...
                        writeSettings(
                          SettingsModal(enableLogging: enableLogging),
                        );
                      },
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        await writeSettings(
                          SettingsModal(
                            preferredProvider: sources[index].identifier,
                          ),
                        );
                        setState(() {});
                        setcState(() {});
