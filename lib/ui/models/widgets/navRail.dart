...
class _AnimeStreamNavRailState extends State<AnimeStreamNavRail> {
  ...
  Widget build(BuildContext context) {
    final shouldCollapse =
        (MediaQuery.sizeOf(context).width < 1200) && widget.autoCollapse;


    final double width = shouldCollapse || !widget.shouldExpand
        ? 60
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: shouldCollapse
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color:
                                      currentIndex == index && !isNonNavButton
