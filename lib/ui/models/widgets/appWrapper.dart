    ...
    return Scaffold(
      appBar:
          ...
          ? PreferredSize(
              ...
              child: Container(
                color:
                    Provider.of<AppProvider>(context).titleBarColor ??
                    appTheme.backgroundColor.withAlpha(150),
                child: Row(
          ...
          return Listener(
            ...
            child: PopScope(
              ...
              onPopInvokedWithResult: (didPop, result) async {
                if (didPop) return;
                final innerNav = navKey.currentState;
                if (innerNav != null && innerNav.canPop()) {
                  innerNav.pop();
                } else {


                  final handled = await innerNav?.maybePop() ?? false;
                  if (!handled) {
        ...
        child: Container(
          ...
          child: SvgPicture.asset(
            ...
            colorFilter: ColorFilter.mode(
              hovered
                  ? (widget.iconColorOnHover ?? appTheme.textMainColor)
