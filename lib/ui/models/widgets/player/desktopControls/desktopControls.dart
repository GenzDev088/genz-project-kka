...
class _DesktopControlsState extends State<DesktopControls> {
  ...
  void keyListener(KeyEvent key) async {
    ...
    switch (key.logicalKey) {
      ...
      case LogicalKeyboardKey.arrowLeft:
        {
          await provider.fastForward(
            -(currentUserSettings?.skipDuration ?? 15),
          );
          break;
        }
                            ...
                            child: Slider(
                              value:
                                  dataProvider.state.sliderValue.toDouble() >
                                      (provider.controller.duration ?? 0)
                                  ? (provider.controller.duration ?? 0)
                                        .toDouble()
                                  : dataProvider.state.sliderValue.toDouble(),
                              thumbColor: Colors.white,
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            icon: makeIcon(Icons.picture_in_picture),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                              ...
                              ContextMenuItem(
                                ...
                                onClick: () {
                                  Navigator.of(context)
                                      ...
                                      .then(
                                        (v) => dataProvider.initSubsettings(),
                                      );
                                },
                              ),
                            ],
                          ...
                          IconButton(
                            ...
                            icon: makeIcon(
                              context.select<AppProvider, bool>(
                                    (prov) => prov.isFullScreen,
                                  )
                      ...
                      tabs: [
                        Tab(
                          child: DefaultTabController.of(context).index == 0
                              ? Text("Qualities", style: textStyle)
                              : Icon(Icons.hd_outlined),
                        ),
                        Tab(
                          child: DefaultTabController.of(context).index == 1
                              ? Text("Servers", style: textStyle)
                                  ...
                                  child: GestureDetector(
                                    ...
                                    onTap: () async {
                                      dataProvider.updateCurrentQuality(
                                        dataProvider.state.qualities[index],
                                      );
                                      provider.playVideo(
                                        dataProvider.state.qualities[index].url,
                                        currentStream:
                                            dataProvider.state.currentStream,
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return MouseRegion(
                                  ...
                                  child: GestureDetector(
                                    onTap: () async {
                                      dataProvider.updateCurrentStream(
                                        dataProvider.state.streams[index],
                                      );
                                      await dataProvider
                                          .extractCurrentStreamQualities();
                                      final q = dataProvider
                                          .getPreferredQualityStreamFromQualities();
  ...
  Icon makeIcon(IconData id, {double customSize = 40}) {
    return Icon(id, size: customSize, color: Colors.white);
  }
