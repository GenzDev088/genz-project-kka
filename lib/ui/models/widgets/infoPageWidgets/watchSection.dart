...
class WatchSection extends StatelessWidget {
          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  SourceSideWidget(provider: provider),
                  ContinueWatchingSideBox(provider: provider),
                ],
              ),
            ),
          ),
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    if (provider.currentPageIndex >=
                                        provider.visibleEpList.length - 1)
                                      return;
                                    provider.currentPageIndex += 1;
                                  },
                                  icon: Icon(
  ...
  Widget _buildSubDubButton(bool isDub) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: provider.preferDubs == isDub
      ...
      child: IconButton(
        ...
        icon: Text(
          isDub ? "dub" : "sub",
          style: TextStyle(
            color: provider.preferDubs == isDub ? appTheme.onAccent : null,
