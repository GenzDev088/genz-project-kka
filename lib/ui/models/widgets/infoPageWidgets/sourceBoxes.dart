...
class SourceSideWidget extends StatelessWidget {
  ...
  const SourceSideWidget({super.key, required this.provider});
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              ...
                              showDialog(
                                ...
                                final links = await SourceManager.instance
                                    .getAnimeEpisodes(
                                      provider.selectedSource.identifier,
                                      result['alias'],
                                    );
...
class SourceBodyWidget extends StatelessWidget {
  final InfoProvider provider;
  const SourceBodyWidget({super.key, required this.provider});
