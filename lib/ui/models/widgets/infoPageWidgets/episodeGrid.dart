...
class InfoPageEpisodeGrid extends StatelessWidget {
            ...
            child: MouseRegion(
              ...
              child: ValueListenableBuilder(
                ...
                builder: (context, value, child) {
                  ...
                  final desktopWidgets = [
                    _episodeTileDesktop,
                    _episodeGridTileDesktop,
                    _episodeCompactTileDesktop,
                  ];
                  return desktopWidgets[provider.viewMode](
                    hovered,
                    index,
                    context,
                  );
  ...
  Widget _episodeCompactTileDesktop(
    ValueNotifier<bool> hovered,
    int index,
    BuildContext context,
  ) {
    final episodeNumber =
        provider.visibleEpList[provider.currentPageIndex][index]['realIndex'] +
        1;
    ...
    return ContextMenu(
      menuItems: [
        ...
        ContextMenuItem(
          icon: Icons.download,
          label: "Download",
          onClick: () => _showDownloadDialog(context, provider, index),
        ),
      ],
      child: Container(
  ...
  Widget _episodeGridTileDesktop(
    ValueNotifier<bool> hovered,
    int index,
    BuildContext context,
  ) {
  ...
  Widget _episodeTileDesktop(
    ValueNotifier<bool> hovered,
    int index,
    BuildContext context,
  ) {
    final episode =
        provider.visibleEpList[provider.currentPageIndex][index]['epLink']
            as EpisodeDetails;
    final episodeNumber = episode.episodeNumber;
    final thumbnail = episode.thumbnail ?? provider.data.cover;
    final title =
        episode.episodeTitle != null && episode.episodeTitle!.isNotEmpty
