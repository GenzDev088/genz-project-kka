...
class ContinueWatchingSideBox extends StatelessWidget {
  ...
  ContinueWatchingSideBox({super.key, required this.provider});
  ...
  Widget build(BuildContext context) {
    ...
    final int watchedProgress = (value.isNaN || value.isInfinite)
        ? 0
        : value.toInt();
...
class ContinueWatchingBodyBox extends StatelessWidget {
  final InfoProvider provider;
  const ContinueWatchingBodyBox({super.key, required this.provider});
  ...
  Widget build(BuildContext context) {
    ...
    final double value = (raw is num)
        ? raw.toDouble()
        : double.tryParse(raw.toString()) ?? 0.0;
    final watchedProgress = (value.isNaN || value.isInfinite)
        ? 0
        : value.toInt();
    final size = MediaQuery.sizeOf(context);
                ...
                child: Column(
                  ...
                  children: [
                    TweenAnimationBuilder<double>(
                      tween: Tween<double>(
                        begin: 0,
                        end: watchedProgress.toDouble() / 100,
                      ),
                      duration: Duration(milliseconds: 800),
                      curve: Curves.easeOutCubic,
                      builder: (context, value, _) {
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    "Your progress",
                                    style: TextStyle(
                                      color: appTheme.textMainColor.withAlpha(
                                        204,
                                      ),
                                      fontFamily: "Poppins",
                                      fontSize: 14,
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  width:
                                      size.width /
                                      5 *
                                      value, // This value is roughly the size of bar
                                  decoration: BoxDecoration(
                                    gradient: LinearGradient(
                                      begin: Alignment.centerLeft,
                                      end: Alignment.centerRight,
