      ...
      children: [
        Padding(
          ...
          child: Column(
            ...
            children: [
              CommonInfo(provider: provider, splitWidth: splitWidth),
              Container(
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(provider.data.type, style: _textStyle()),
                        ),
                        Container(
                        ...
                        Text(
                          "${provider.data.episodes ?? "??"} Episodes",
                          style: _textStyle(),
                        ),
                      ],
                    ),
                    ...
                    if (size.width <= splitWidth)
                      Container(
                        ...
                        child: Column(
                          spacing: 20,
                          children: [
                            Text("Synopsis", style: _textStyle()),
                            Text(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _infoBoxItem(
                                      "Duration:",
                                      provider.data.duration,
                                    ),
                                    _infoBoxItem(
                                      "Studios:",
                                      provider.data.studios.join(", "),
                                    ),
                                    _infoBoxItem(
                                      "Air start",
    ...
    return Row(
      ...
      children: [
        Padding(
          ...
          child: Text(key, style: _textStyle().copyWith(fontSize: 20)),
        ),
        Text(
          value,
          style: _textStyle().copyWith(
