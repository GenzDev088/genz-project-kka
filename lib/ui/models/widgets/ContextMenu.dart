...
class _ContextMenuState extends State<ContextMenu> {
  ...
  void _showContextMenu(Offset pos) {
    ...
    final hoverList = List.generate(
      widget.menuItems.length,
      (ind) => ValueNotifier<bool>(false),
    );
    ...
    controller.show(
      ...
      contextMenuBuilder: (context) => Stack(
        children: [
          ...
          Positioned(
            top: pos.dy,
            left: pos.dx + width > MediaQuery.of(context).size.width
                ? pos.dx - width
                : pos.dx,
            child: ClipRRect(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  height:
                      (widget.menuItems.length * 40) +
                      12 +
                      (widget.header != null ? 50 : 0), //add the padding
                  width: width,
                  child: Column(
                    children: [
                      if (widget.header != null)
                        SizedBox(height: 50, child: widget.header!),
                      Expanded(
