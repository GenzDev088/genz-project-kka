...
class _SimpleAnimePainter extends CustomPainter {
  ...
  _SimpleAnimePainter({required this.color, required this.animation});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      final pulseFactor =
          0.6 +
          0.4 * math.sin(animation.value * math.pi * 2 + i * math.pi * 2 / 3);
    ...
    final centerPulseFactor =
        0.8 + 0.2 * math.sin(animation.value * math.pi * 4);
