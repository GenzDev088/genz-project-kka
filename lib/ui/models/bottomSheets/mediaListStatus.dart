...
class MediaListStatusBottomSheet extends StatefulWidget {
  ...
  const MediaListStatusBottomSheet({super.key, required this.provider});
...
class _MediaListStatusBottomSheetState
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      width: isDialog
          ? min(500, MediaQuery.of(context).size.width * 0.85)
          : double.infinity,
                  ...
                  _ProgressButton(
                    ...
                    onPressed: () {
                      ...
                      if (currentNumber + 1 >= (provider.data.episodes ?? 0)) {
                        menuController.value = TextEditingValue(
                          text: "COMPLETED",
                        );
                    ...
                    child: _ActionButton(
                      ...
                      onPressed: () {
                        ...
                        if (markedDelete) {
                          SyncHandler()
                              .deleteAnimeEntry(
                                id: provider.data.listId ?? provider.id,
                        ...
                        if (selectedValue != null ||
                            progress != provider.watched ||
                            provider.mediaListStatus == null) {
                          SyncHandler()
                              .mutateAnimeList(
                                id: provider.id,
                                status: assignItemEnum(
                                  selectedValue ?? initialSelection!,
                                ),
                                previousStatus: assignItemEnum(
                                  initialSelection,
                                ),
                                progress: progress,
                                otherIds: provider.altDatabases,
