...
class SettingsModal {
  ...
  factory SettingsModal.fromMap(Map<dynamic, dynamic> map) {
    return SettingsModal(
      ...
      downloadPath:
          map['downloadPath'], // No default value since we can assign them at runtime according to OS
      ...
      preferredSubtitleLanguage:
          map['preferredSubtitleLanguage'] ?? "Indonesian",
    );
  }
...
class UserPreferencesModal {
  ...
  factory UserPreferencesModal.fromMap(Map<dynamic, dynamic> map) {
    return UserPreferencesModal(
      ...
      subtitleSettings: map['subtitleSettings'] != null
          ? SubtitleSettings.fromMap(map['subtitleSettings'])
          : SubtitleSettings(),
  ...
  Map<dynamic, dynamic> toMap() {
    return {
      'episodesViewMode': episodesViewMode != null
          ? getViewModeIndex(episodesViewMode!)
          : null,
...
class AnimeSpecificPreference {
  ...
  factory AnimeSpecificPreference.fromMap(Map<String, dynamic> map) {
    return AnimeSpecificPreference(
      lastWatchDuration: map['lastWatchDuration'] != null
          ? Map.from(map['lastWatchDuration'] as Map<dynamic, dynamic>)
          : null,
      manualSearchQuery: map['manualSearchQuery'] != null
          ? map['manualSearchQuery'] as String
          : null,
      preferredProvider: map['preferredProvider'] != null
          ? map['preferredProvider'] as String
          : null,
    );
  }
  ...
  factory AnimeSpecificPreference.fromJson(String source) =>
      AnimeSpecificPreference.fromMap(
