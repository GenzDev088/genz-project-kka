...
class SimklRelatedRecommendation extends DatabaseRelatedRecommendation {
  ...
  factory SimklRelatedRecommendation.fromJson(Map<String, dynamic> json) {
    return SimklRelatedRecommendation(
      id: json['ids']['simkl'],
      title: {'romaji': json['title'], 'english': json['en_title'] as String?},
      cover: Simkl.imageLink(
        json['poster'] ?? "",
      ), // not really a good idea. But yeah!
...
class SimklInfo extends DatabaseInfo {
  ...
  factory SimklInfo.fromJson(Map<String, dynamic> json) {
    String? getTitleFromAltTitles(int langCode) {
      final titleList = (json['alt_titles'] as List?)
          ?.where((it) => it['lang'] == langCode)
          .toList();
    ...
    return SimklInfo(
      ...
      aired: {'start': json['first_aired'], 'end': json['last_aired']},
      type: json['anime_type'],
      ...
      recommended:
          (json['users_recommendations'] as List?)
              ?.map((rec) => SimklRelatedRecommendation.fromJson(rec))
              .toList() ??
          [],
      banner: json['fanart'] != null
          ? Simkl.imageLink(json['fanart'], fanart: true)
          : null,
      status: json['status'],
      ...
      studios: (json['studios'] as List)
          ...
          .toList(),
      synonyms: json['alt_titles']
          .map<String?>((alt) => alt['name'] as String?)
          .toList(),
      related:
          (json['relations'] as List?)
              ?.map((rel) => SimklRelatedRecommendation.fromJson(rel))
              .toList() ??
          [],
      ...
      alternateDatabases: [
        if (json['ids']['anilist'] != null)
          AlternateDatabaseId(
            database: Databases.anilist,
            id: int.parse(json['ids']['anilist']),
          ),
        AlternateDatabaseId(
        ...
        if (json['ids']['mal'] != null)
          AlternateDatabaseId(
            database: Databases.mal,
            id: int.parse(json['ids']['mal']),
          ),
      ],
    );
  }
