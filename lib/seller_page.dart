...
class _SellerPageState extends State<SellerPage> {
  ...
  Future<void> _create() async {
    ...
    if (u.isEmpty || p.isEmpty || d.isEmpty)
      return _alert("❗ Semua field wajib diisi");
  ...
  Future<void> _edit() async {
    ...
    if (u.isEmpty || d.isEmpty)
      return _alert("❗ Username dan durasi wajib diisi");
    setState(() => loading = true);
    final res = await http.get(
      Uri.parse(
      ...
      builder: (_) => BackdropFilter(
        ...
        child: AlertDialog(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: BorderSide(color: cyanAccent.withOpacity(0.3), width: 1.5),
          ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [charcoal, charcoal.withOpacity(0.8)],
        ),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: cyanAccent.withOpacity(0.3), width: 1.5),
        boxShadow: [
          BoxShadow(
  ...
  Widget _buildGlassInputField({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(colors: [charcoal, charcoal.withOpacity(0.8)]),
      ),
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(icon, color: cyanAccent),
          filled: false,
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(16),
            borderSide: BorderSide(color: cyanAccent.withOpacity(0.3)),
          ),
  ...
  Widget _buildSectionTitle(String title, IconData icon) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, color: cyanAccent, size: 24),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                gradient: RadialGradient(
                  colors: [blueAccent.withOpacity(0.08), Colors.transparent],
                ),
              ),
            ),
          ),
                  ...
                  children: [
                    _buildGlassCard(
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.store, color: cyanAccent, size: 32),
                          const SizedBox(width: 12),
                          const Text(
                            "RESELLER PANEL",
                            style: TextStyle(
                    ...
                    _buildGlassCard(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.info, color: cyanAccent, size: 20),
                          const SizedBox(width: 12),
                          Expanded(
                            child: Text(
