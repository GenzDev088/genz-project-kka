...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.shafique.flutter_vpn_service.FlutterVpnServicePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_vpn_service, com.shafique.flutter_vpn_service.FlutterVpnServicePlugin", e);
    }
    try {
